...
let firstset = await YAML.parse(fs.readFileSync('./plugins/ql-plugin/config/2f18.yaml', 'utf8'));
...
export class ql2f18 extends plugin {
  ...
  async ql2f18(e) {
    ...
    let set = await YAML.parse(fs.readFileSync('./plugins/ql-plugin/config/2f18.yaml', 'utf8'));
