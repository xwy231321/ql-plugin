...
let firstset = await YAML.parse(fs.readFileSync('./plugins/ql-plugin/config/2r18.yaml', 'utf8'));
...
export class ql2r18 extends plugin {
  ...
  async ql2r18(e) {
    ...
    let set = await YAML.parse(fs.readFileSync('./plugins/ql-plugin/config/2r18.yaml', 'utf8'));
